...
const { key, cert, allRoles, healthgainzConfig, checkCredentials, handleError } = require('./HealthGainzLibrary')
...
httpsServer.listen(port, () => {
    console.log('Microservice \'HealthGainz:Videos\' running on port ' + port)
})
